...
#[derive(Debug)]
pub struct ThinSlice<'a> {
    ptr: *mut f32,
    phantom_data: PhantomData<&'a ()>,
}

impl<'a> Index<usize> for ThinSlice<'a> {
    type Output = f32;
...
impl<'a> IndexMut<usize> for ThinSlice<'a> {
    #[inline]
...
#[inline]
fn split_at_mut_thin(slice: &mut [f32], mid: usize) -> (ThinSlice, &mut [f32]) {
